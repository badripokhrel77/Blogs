...
<head>
  ...
  <title>@yield('title','Badri Pokhrel')</title>
  <!-- Bootstrap CSS -->
  ...
  <style>
    ...
    .content-wrapper {
      flex: 1; /* Ensures this section grows to take available space */
    }
    .navbar {
      background-color: rgb(223, 233, 228);
    }
    .navbar-brand {
...
<body>
  <nav class="navbar navbar-expand-lg sticky-top">
    <div class="container">
      <a class="navbar-brand" href="{{url('home')}}">Badri Pokhrel</a>
...
@endif
  ...
  <footer>
    <div class="container">
      <h5 class="text-uppercase" style="color: orange;">Badri Pokhrel</h5>
      <p class="small">Sharing thoughts, stories, and ideas with the world.</p>
    ...
    <div class="text-white mt-4 small">
      &copy; 2024 Badri Pokhrel. All Rights Reserved.
    </div>
  </footer>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="{{url('user')}}">
                              <div class="sb-nav-link-icon"><i class="fas fa-user-cog"></i>
                              </div>
                             Users
                          </a>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Demo Project 2024</div>
                            <div>
